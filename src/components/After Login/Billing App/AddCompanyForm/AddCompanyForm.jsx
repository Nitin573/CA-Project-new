...
const AddCompanyForm = () => {
  ...
  useEffect(() => {
    const companyData = store.get_firm_data.find((company) => company.userId === UserDetails?.userId);
    setSelectedCompanyData(companyData);
  }, [UserDetails, store.get_firm_data]);

  const [formData, setFormData] = useState({
    companyLogo: selectedCompanyData?.companyLogo || "",
  ...
  const handleRegisterFirm = () => {
    ...
    dispatch(firmRegisterAction(formDataToSend, UserDetails?.token));
  };
